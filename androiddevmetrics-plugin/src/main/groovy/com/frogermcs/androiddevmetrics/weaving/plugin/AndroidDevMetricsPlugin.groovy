...
public class AndroidDevMetricsPlugin implements Plugin<Project> {
  @Override void apply(Project project) {
    ...
    project.dependencies {
      releaseCompile 'com.davidyorr.androiddevmetrics:androiddevmetrics-runtime-noop:0.4'
      debugCompile 'com.davidyorr.androiddevmetrics:androiddevmetrics-runtime:0.4'
